...
The generated compose file is regenerated by `gen-compose-zoned.sh`, so don't
edit it directly. Instead, create a separate compose file and merge at runtime:
...
services:
  my-service:
    image: my-image
    networks:
      - org-seeddrill   # talk to proxy/keeper
      # - backbone      # or full mesh access
...
Compose merges the files. Your services persist across topology regeneration.
